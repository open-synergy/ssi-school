...
class SchoolAdmissionWizardCreateInvoiceExport(models.TransientModel):
    ...
    Export wizard for school admissions. The selected operating unit
    ...
    _inherit = "school_admission.wizard_create_invoice_export"
    ...
    operating_unit_id = fields.Many2one(
        ...
        help=(
            ...
            "operating unit of the selected admission(s), since the "
    ...
    def _check_moves(self, moves):
        ...
        :param moves: ``account.move`` recordset collected from the
            selected admissions, before operating unit filtering
...
Solution: Select a different operating unit, or select admission(s) invoiced under \
operating unit '%s'
"""
                )
                % (
