...
odoo.define("ssi_school_admission.school_admission_payment_template_tour", function (
    require
) {
    "use strict";
    ...
    tour.register(
        ...
        [].concat(openPaymentTemplateList(), [
    ...
    tour.register(
        ...
        [].concat(openPaymentTemplateList(), [
            ...
            // Flow 7 -- Reset code.
            {
                ...
                trigger: ".breadcrumb-item.o_back_button a:contains(Payment Templates)",
            },
            {
