        ...
        [].concat(
            ...
            [
                ...
                },
                {
                    ...
                    trigger:
                        ".o_data_row:contains(TOUR Grade Type Edit Changed) .o_list_record_selector input:not(:checked)",
                    run: function () {
                        // Assertion only; do not trigger the default click action.
                    },
                },
                ...
                // values.
                {
                    content: "Grade Types list is displayed",
                    trigger: ".o_list_view",
        ...
        [].concat(
            ...
            [
                ...
                // baris ini PASTI hilang dari situ -- gerbang yang sah.
                {
                    ...
                    trigger:
                        ".o_list_view:not(:has(.o_data_row:contains(TOUR Grade Type Activate)))",
                    run: function () {
                        // Assertion only; do not trigger the default click action.
                    },
                },
