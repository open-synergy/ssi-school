...
odoo.define("ssi_school.school_grade_class_tour", function (require) {
    "use strict";

    var tour = require("web_tour.tour");

    // Shared navigation block reused by every tour below -- Flow 1 of every
    // school_grade_class IK: "Open the School > Configuration > Grade >
    // Grade Classes menu." "Grade" (ssi_school.menu_grade_configuration) is
    // a level-3 grouping menuitem with no action= attribute, so 14.0
    // renders it as a non-clickable dropdown header without
    // data-menu-xmlid -- there is no step for it (patterns.md skill
    // odoo-development-ui-test §A).
    function openGradeClassList() {
        return [
            ...
            {
                content: "Open the Grade Classes menu",
                trigger:
                    '.o_menu_sections [data-menu-xmlid="ssi_school.school_grade_class_menu"]',
            },
            {
                // Gerbang: tunggu action TUJUAN benar-benar terpasang, bukan
                // sekadar "ada list di layar" (patterns.md §A).
                content: "School Grade Classes list is displayed",
                trigger:
                    ".o_control_panel .breadcrumb-item.active:contains(School Grade Classes)",
    ...
    tour.register(
        "ssi_school_school_grade_class_create",
        {
            test: true,
            url: "/web",
        },
        [].concat(
            ...
            [
                ...
                // School, Grade. Grade Type is auto-filled and read-only,
                // and Capacity is left at its 0 (unlimited) default.
                {
                    content: "Fill in the Name",
                    trigger: ".o_field_widget[name='name']",
                    extra_trigger: ".o_form_view.o_form_editable",
                    run: "text TOUR Grade Class Create",
                },
                {
                ...
                },
                {
                    ...
                    run: "text TOUR Grade Class School",
                },
                {
                    content: "Pick the School from the dropdown",
                    trigger:
                        ".ui-autocomplete .ui-menu-item a:contains(TOUR Grade Class School)",
                    in_modal: false,
                },
                {
                    content: "Select the Grade",
                    trigger: ".o_field_many2one[name='grade_id'] input",
                    run: "text TOUR Grade Class Grade",
                },
                {
                    content: "Pick the Grade from the dropdown",
                    trigger:
                        ".ui-autocomplete .ui-menu-item a:contains(TOUR Grade Class Grade)",
                    in_modal: false,
                },
                ...
                // ── Post-Condition — a new Grade Class record is created
                // and active.
                {
                    content: "Record is saved",
                    trigger:
                        ".o_control_panel .breadcrumb-item.active:contains(TOUR Grade Class Create)",
    ...
    tour.register(
        "ssi_school_school_grade_class_edit",
        {
            test: true,
            url: "/web",
        },
        [].concat(
            ...
            [
                // ── Flow 2 — Find and open the record to edit.
                {
                    ...
                    trigger:
                        ".o_data_row:contains(TOUR Grade Class Edit) .o_data_cell:first",
                    extra_trigger: ".o_list_view",
                },
                {
                ...
                // School, Grade, Capacity). Only Name is changed here; Code
                // is left as "/" so Flow 4 (Generate Code) has an effect.
                {
                    content: "Change the Name",
                    trigger: ".o_field_widget[name='name']",
                    run: "text TOUR Grade Class Edit Changed",
                },
                ...
                },
                {
                    content: "Record is saved by Generate Code",
                    trigger:
                        ".o_control_panel .breadcrumb-item.active:contains(TOUR Grade Class Edit Changed)",
                    run: function () {
                        // Assertion only; do not trigger the default click action.
                    },
                },
                ...
                // ── Flow 6 — Go back to the Grade Classes list, select the
                // record's checkbox, click Reset code, then click OK to
                // confirm. This resets the Code field back to "/".
                {
                    content:
                        "Click the School Grade Classes breadcrumb to return to the list",
                    trigger:
                        ".breadcrumb-item.o_back_button a:contains(School Grade Classes)",
                },
                {
                    content: "Select the record's checkbox",
                    trigger:
                        ".o_data_row:contains(TOUR Grade Class Edit Changed) .o_list_record_selector input",
                    run: "click",
                },
                {
                ...
                },
                {
                    ...
                    trigger:
                        ".o_data_row:contains(TOUR Grade Class Edit Changed) .o_list_record_selector input:not(:checked)",
                    run: function () {
                        // Assertion only; do not trigger the default click action.
                    },
                },
                ...
                // values.
                {
                    content: "Grade Classes list is displayed",
                    trigger: ".o_list_view",
    ...
    tour.register(
        "ssi_school_school_grade_class_delete",
        {
            test: true,
            url: "/web",
        },
        [].concat(
            ...
            [
                ...
                // the checkbox).
                {
                    content: "Select the record's checkbox",
                    trigger:
                        ".o_data_row:contains(TOUR Grade Class Delete) .o_list_record_selector input",
                    run: "click",
                },
                ...
                // removed from the system.
                {
                    ...
                    trigger:
                        ".o_list_view:not(:has(.o_data_row:contains(TOUR Grade Class Delete)))",
                    run: function () {
                        // Assertion only; do not trigger the default click action.
                    },
                },
    ...
    tour.register(
        "ssi_school_school_grade_class_deactivate",
        {
            test: true,
            url: "/web",
        },
        [].concat(
            ...
            [
                ...
                // (check the checkbox).
                {
                    content: "Select the record's checkbox",
                    trigger:
                        ".o_data_row:contains(TOUR Grade Class Deactivate) .o_list_record_selector input",
                    run: "click",
                },
                ...
                // longer appear in the default list view.
                {
                    ...
                    trigger:
                        ".o_list_view:not(:has(.o_data_row:contains(TOUR Grade Class Deactivate)))",
                    run: function () {
                        // Assertion only; do not trigger the default click action.
                    },
                },
    ...
    tour.register(
        "ssi_school_school_grade_class_activate",
        {
            test: true,
            url: "/web",
        },
        [].concat(
            ...
            [
                ...
                // (check the checkbox).
                {
                    ...
                    trigger:
                        ".o_data_row:contains(TOUR Grade Class Activate) .o_list_record_selector input",
                    run: "click",
                },
                ...
                // baris ini PASTI hilang dari situ -- gerbang yang sah.
                {
                    ...
                    trigger:
                        ".o_list_view:not(:has(.o_data_row:contains(TOUR Grade Class Activate)))",
                    run: function () {
                        // Assertion only; do not trigger the default click action.
                    },
                },
                ...
                },
                {
                    ...
                    trigger: ".o_data_row:contains(TOUR Grade Class Activate)",
                    run: function () {
                        // Assertion only; do not trigger the default click action.
                    },
                },
    ...
    // Chrome.
    tour.register(
        "ssi_school_school_grade_class_print",
        {
            test: true,
            url: "/web",
        },
        [].concat(
            ...
            [
                ...
                {
                    content: "Open the grade class record",
                    trigger:
                        ".o_data_row:contains(TOUR PRINT GRADE CLASS) .o_data_cell:first",
                    extra_trigger: ".o_list_view",
                },
                {
                    content: "Grade class form is displayed",
                    trigger: ".o_form_view",
                    run: function () {
                        // Assertion only; do not trigger the default click action.
                    },
                ...
                // and the grade class form is displayed again. Whether a
                // report is actually generated and downloaded is out of
                // tour scope.
                {
                    content: "Wizard is closed and the grade class form is displayed",
                    trigger: ".o_form_view",
                    extra_trigger: "body:not(:has(.modal))",
                    run: function () {
                        // Assertion only; do not trigger the default click action.
