...
odoo.define("ssi_school.school_branch_tour", function (require) {
    "use strict";

    var tour = require("web_tour.tour");

    // Shared navigation block reused by every tour below -- Flow 1 of every
    // school_branch IK: "Open the School > Configuration > Branches menu."
    // Branches is a leaf entry directly under Configuration -- there is no
    // grouping header in between (unlike school/school_grade_type/
    // school_grade/school_grade_class, which sit under the "Grade" header).
    function openBranchList() {
        return [
            ...
            {
                content: "Open the Branches menu",
                trigger:
                    '.o_menu_sections [data-menu-xmlid="ssi_school.school_branch_menu"]',
            },
            {
                ...
                trigger: ".o_control_panel .breadcrumb-item.active:contains(Branches)",
    ...
    tour.register(
        "ssi_school_school_branch_create",
        {
            test: true,
            url: "/web",
        },
        [].concat(
            // ── Flow 1 — Open the School > Configuration > Branches menu.
            openBranchList(),
            [
                ...
                // Center is defaulted from the current company, so it is
                // not touched here.
                {
                    content: "Fill in the Name",
                    trigger: ".o_field_widget[name='name']",
                    extra_trigger: ".o_form_view.o_form_editable",
                    run: "text TOUR Branch Create",
                },
                {
                ...
                // ── Post-Condition — a new Branch record is created and
                // active.
                {
                    content: "Record is saved",
                    trigger:
                        ".o_control_panel .breadcrumb-item.active:contains(TOUR Branch Create)",
        ...
        [].concat(
            ...
            [
                // ── Flow 2 — Find and open the record to edit.
                {
                    ...
                    trigger:
                        ".o_data_row:contains(TOUR Branch Edit) .o_data_cell:first",
                    extra_trigger: ".o_list_view",
                },
                {
                ...
                // Center). Only Name is changed here; Code is left as "/"
                // so Flow 4 (Generate Code) has an effect.
                {
                    content: "Change the Name",
                    trigger: ".o_field_widget[name='name']",
                    run: "text TOUR Branch Edit Changed",
                },
                ...
                },
                {
                    content: "Record is saved by Generate Code",
                    trigger:
                        ".o_control_panel .breadcrumb-item.active:contains(TOUR Branch Edit Changed)",
                    run: function () {
                        // Assertion only; do not trigger the default click action.
                    },
                },
                ...
                // ── Flow 6 — Go back to the Branches list, select the
                // record's checkbox, click Reset code, then click OK to
                // confirm. This resets the Code field back to "/".
                {
                    content: "Click the Branches breadcrumb to return to the list",
                    trigger: ".breadcrumb-item.o_back_button a:contains(Branches)",
                },
                {
                    content: "Select the record's checkbox",
                    trigger:
                        ".o_data_row:contains(TOUR Branch Edit Changed) .o_list_record_selector input",
                    run: "click",
                },
                {
    ...
    tour.register(
        "ssi_school_school_branch_delete",
        {
            test: true,
            url: "/web",
        },
        [].concat(
            ...
            [
                ...
                // the checkbox).
                {
                    content: "Select the record's checkbox",
                    trigger:
                        ".o_data_row:contains(TOUR Branch Delete) .o_list_record_selector input",
                    run: "click",
                },
                ...
                // removed from the system.
                {
                    ...
                    trigger:
                        ".o_list_view:not(:has(.o_data_row:contains(TOUR Branch Delete)))",
                    run: function () {
                        // Assertion only; do not trigger the default click action.
                    },
                },
    ...
    tour.register(
        "ssi_school_school_branch_deactivate",
        {
            test: true,
            url: "/web",
        },
        [].concat(
            ...
            [
                ...
                // (check the checkbox).
                {
                    content: "Select the record's checkbox",
                    trigger:
                        ".o_data_row:contains(TOUR Branch Deactivate) .o_list_record_selector input",
                    run: "click",
                },
                ...
                // longer appear in the default list view.
                {
                    ...
                    trigger:
                        ".o_list_view:not(:has(.o_data_row:contains(TOUR Branch Deactivate)))",
                    run: function () {
                        // Assertion only; do not trigger the default click action.
                    },
                },
    ...
    tour.register(
        "ssi_school_school_branch_activate",
        {
            test: true,
            url: "/web",
        },
        [].concat(
            ...
            [
                ...
                // (check the checkbox).
                {
                    ...
                    trigger:
                        ".o_data_row:contains(TOUR Branch Activate) .o_list_record_selector input",
                    run: "click",
                },
                ...
                },
                {
                    ...
                    trigger: ".o_data_row:contains(TOUR Branch Activate)",
                    run: function () {
                        // Assertion only; do not trigger the default click action.
                    },
                },
    ...
    // Chrome.
    tour.register(
        "ssi_school_school_branch_print",
        {
            test: true,
            url: "/web",
        },
        [].concat(
            ...
            [
                ...
                {
                    content: "Open the branch record",
                    trigger:
                        ".o_data_row:contains(TOUR PRINT BRANCH) .o_data_cell:first",
                    extra_trigger: ".o_list_view",
                },
                {
                    content: "Branch form is displayed",
                    trigger: ".o_form_view",
                    run: function () {
                        // Assertion only; do not trigger the default click action.
                    },
                ...
                // and the branch form is displayed again. Whether a report
                // is actually generated and downloaded is out of tour
                // scope.
                {
                    content: "Wizard is closed and the branch form is displayed",
                    trigger: ".o_form_view",
