...
class SchoolEnrollment(models.Model):
    ...
    from this enrollment's payment terms into a
    ...
    create_invoice_export_ok = fields.Boolean(
        ...
        help=(
            ...
            "generated from this enrollment's payment terms may be "
            "exported via the Create Invoice Export wizard."
        ),
    )

    def _get_exportable_move(self):
        """Return the ``account.move`` of this enrollment's unpaid invoices.
    ...
    def _check_create_invoice_export_policy(self):
        """Ensure this enrollment is allowed to export invoices.
...
"""
    ...
    def action_open_create_invoice_export_wizard(self):
        """Open the wizard to export unpaid invoices of this enrollment.
    ...
    def _open_create_invoice_export_wizard(self):
        ...
        Passes this enrollment via the
        ...
        waction = self.env.ref(
            ...
            "school_enrollment_wizard_create_invoice_export_action"
        ).read()[0]
        waction.update(
            {
                "context": {
